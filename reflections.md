...
<div class="paper-container">
  <div class="document-viewer">
    <div class="document-placeholder">
      <i class="fas fa-file-word" style="font-size: 4rem; color: #2b579a; margin-bottom: 1rem;"></i>
      <h3>General Education Reflection</h3>
      <p>Comprehensive reflection on general education classes</p>
    </div>
    <div class="viewer-controls">
      <a href="/assets/documents/reflections/GenEdReflection.docx" target="_blank" class="view-cert">
        <i class="fas fa-download"></i> Download Word Document
      </a>
    </div>
  </div>
